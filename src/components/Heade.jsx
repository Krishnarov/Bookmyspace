...
function Heade({ setIsOpen, IsOpen }) {
  ...
  return (
    <div className="bg-white dark:bg-[#212529] transition-colors duration-300">
      <div className="flex md:justify-end justify-between items-center border-b md:px-8 px-4 border-slate-300 dark:border-slate-700 py-2 transition-colors duration-300">
        {/* Mobile view */}
